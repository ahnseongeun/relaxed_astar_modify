...
ros::NodeHandle n;
relaxed_astar::Meter msg;
ros::Publisher chatter_pub = n.advertise<relaxed_astar::Meter>("/test", 1);
...
vector<int> RAstarPlannerROS::findPath(int startCell, int goalCell, float g_score[])
{
	...
	{
    n.advertise<relaxed_astar::Meter>("/test", 1);
